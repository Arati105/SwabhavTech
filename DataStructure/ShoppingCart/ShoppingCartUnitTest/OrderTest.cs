...
namespace ShoppingCartLibTest
{
    ...
    public class OrderTest
    {
        ...
        {
            order.AddItem(new LineItem(1, new Product(101, "Book", 20, 50f), 2));
            order.AddItem(new LineItem(2, new Product(101, "Book", 20, 50f), 2));
        ...
        {
            order.AddItem(new LineItem(1001, new Product(101, "Book", 20, 50f), 2));
            order.AddItem(new LineItem(1002, new Product(101, "Book", 20, 50f), 2));
